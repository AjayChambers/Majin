...
using Iterator   = JBox::Buffer::Iterator;
using value_type = JBox::Buffer::value_type;
using size_type  = JBox::Buffer::size_type;
using pointer    = JBox::Buffer::pointer;
using reference  = JBox::Buffer::reference;
...
namespace JBox {
    ...
    {
        if (index > size_) {
            throw std::out_of_range("JsonBuffer::iter_at index out of range");
        }
    ...
    {
        if (index >= size_) {
            throw std::out_of_range("JsonBuffer::at index out of range");
        }
